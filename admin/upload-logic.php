...
if(isset($_POST['submit'])){
    ...
    $trending = filter_var($_POST['trending'], FILTER_SANITIZE_NUMBER_INT);
    ...
    if(isset($_SESSION['add-post'])){
        ...
        header('location: ' . ROOT_URL . 'upload.php');
        die();
    }else{
        // insert post into database
        $query = "INSERT INTO movie(title, link, body, thumbnail, rate, time, vq, category_id, trending, age) VALUES ('$title', '$link', '$body', '$thumbnail_name', '$rate', '$times', '$vq', $category_id, '$trending', '$age')";
